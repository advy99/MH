...
Por no extender más este documento, solo compararé las 5 gráficas (una por semilla) de ecoli con un 10\% de restricciones ya que es el único conjunto de datos suficientemente complejo y donde podremos estudiar mejor el comportamiento ya que será más distinguido. El resto se pueden consultar como explica el manual de uso, aunque los algoritmos se comportan igual que con ecoli, solo que convergen mucho más rápido (es necesario ejecutar el programa para obtener los ficheros con los que se generarán las gráficas) o en la carpeta \texttt{graficas/salidas\_png/} ya que realizaré la entrega con una copia de las gráficas en dicha carpeta.
