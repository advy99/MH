...
\begin{lstlisting}
Devuelve: pareja solución (pareja de asignación y valor de f_objetivo ), infactibilidad
Recibe: ini, pareja solución (pareja de asignación y valor de f_objetivo ), infactibilidad
...
\subsubsection{Calculo de temperatura inicial.}

\subsubsection{Método de enfriamiento.}
