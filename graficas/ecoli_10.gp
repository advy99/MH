...
do for[i in semillas] {
	...
	plot "datos/ecoli_set_const_10.const_".i."_AM-1_UN.out" with lines title "AM-1 semilla ".i,\
	"datos/ecoli_set_const_10.const_".i."_AM-0_1_UN.out" with lines title "AM-0.1 semilla ".i, \
	"datos/ecoli_set_const_10.const_".i."_AM-0_1mej_UN.out" with lines title "AM-0.1mej semilla ".i, \
	...
	"datos/ecoli_set_const_10.const_".i."_AM-BL-1_UN.out" with lines title "AM-BL-1 semilla ".i,\
	"datos/ecoli_set_const_10.const_".i."_AM-BL-0_1_UN.out" with lines title "AM-BL-0.1 semilla ".i, \
	"datos/ecoli_set_const_10.const_".i."_AM-BL-0_1mej_UN.out" with lines title "AM-BL-0.1mej semilla ".i
