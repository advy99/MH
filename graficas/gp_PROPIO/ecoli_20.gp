...
do for[i in semillas] {
	...
	plot "../datos/ecoli_set_const_20.const_".i."_ALG-PRO_explorar.out" w lines title "Mejor población explorar" ls 1, \
	     "../datos/ecoli_set_const_20.const_".i."_ALG-PRO_explotar.out" using 1:2 w lines title "Mejor población explotar" ls 2, \
		  "../datos/ecoli_set_const_20.const_".i."_ALG-PRO_explotar.out" using 1:3 w lines title "Peor población explotar" ls 3
}
