...
do for[i in semillas] {
	...
	set output "../salidas_png/newthyroid_set_const_20_".i.".png"


	plot "../datos/newthyroid_set_const_20.const_".i."_ALG-PRO_explorar.out" w lines title "Mejor población explorar" ls 1, \
	     "../datos/newthyroid_set_const_20.const_".i."_ALG-PRO_explotar.out" using 1:2 w lines title "Mejor población explotar" ls 2, \
		  "../datos/newthyroid_set_const_20.const_".i."_ALG-PRO_explotar.out" using 1:3 w lines title "Peor población explotar" ls 3
}
