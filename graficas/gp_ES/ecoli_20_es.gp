...
do for[i in semillas] {
	...
	set output "salidas_png/ecoli_set_const_20_".i."_es.png"


	plot "../datos/ecoli_set_const_20.const_".i."_BO-MOD_fobjetivo.out" with lines title "Boltzmann modificado (Valor F. objetivo) " ls 1,\
	"../datos/ecoli_set_const_20.const_".i."_BO_fobjetivo.out" with lines title "Boltzmann (Valor F. objetivo) " ls 2 , \
	"../datos/ecoli_set_const_20.const_".i."_CA-MOD_fobjetivo.out" with lines title "Cauchy modificado (Valor F. objetivo) " ls 3, \
	"../datos/ecoli_set_const_20.const_".i."_CA_fobjetivo.out" with lines title "Cauchy (Valor F. objetivo) " ls 4, \
	"../datos/ecoli_set_const_20.const_".i."_PRO_fobjetivo.out" with lines title "Proporcional (Valor F. objetivo) " ls 5, \
	"../datos/ecoli_set_const_20.const_".i."_CONST_fobjetivo.out" with lines title "Constante (Valor F. objetivo) " ls 6
