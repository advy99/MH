...
do for[i in semillas] {
	...
	set title "Iris con un 20% de restricciones con la semilla ".i
	set term pngcairo dashed size 1400,1050
	set output "salidas_png/iris_set_const_20_".i."_es.png"


	plot "../datos/iris_set_const_20.const_".i."_BO-MOD_fobjetivo.out" with lines title "Boltzmann modificado (Valor F. objetivo) " ls 1,\
	"../datos/iris_set_const_20.const_".i."_BO_fobjetivo.out" with lines title "Boltzmann (Valor F. objetivo) " ls 2 , \
	"../datos/iris_set_const_20.const_".i."_CA-MOD_fobjetivo.out" with lines title "Cauchy modificado (Valor F. objetivo) " ls 3, \
	"../datos/iris_set_const_20.const_".i."_CA_fobjetivo.out" with lines title "Cauchy (Valor F. objetivo) " ls 4, \
	"../datos/iris_set_const_20.const_".i."_PRO_fobjetivo.out" with lines title "Proporcional (Valor F. objetivo) " ls 5, \
	"../datos/iris_set_const_20.const_".i."_CONST_fobjetivo.out" with lines title "Constante (Valor F. objetivo) " ls 6
